...
syn match   fasmHexNumber       "\<\d\(_\|\x\)*h\>"
syn match   fasmHexNumber       "\<0x\(_\|\x\)*\>"
syn match   fasmHexNumber       "\$\<\(_\|\x\)*\>"
syn match   fasmFPUNumber       "\<\d\+\(\.\d*\)\=\(e[-+]\=\d*\)\=\>"
syn match   fasmOctalNumber     "\<\o\(_\|\o\)\+o\>"
syn match   fasmDecimalNumber   "\<\(0\|[1-9]\(_\|\d\)*\)d\=\>"
